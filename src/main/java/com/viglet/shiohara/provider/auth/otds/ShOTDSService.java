...
import com.viglet.shiohara.provider.auth.otds.bean.ShOTDSAuthenticationResponseBean;
import com.viglet.shiohara.provider.auth.otds.bean.ShOTDSCredencialBean;
import com.viglet.shiohara.provider.auth.otds.bean.ShOTDSTicketRequestBean;
import com.viglet.shiohara.provider.auth.otds.bean.ShOTDSUserResponseBean;
import com.viglet.shiohara.provider.auth.otds.bean.ShOTDSValuesBean;
...
import com.viglet.shiohara.provider.auth.otds.ShOTDSProviderInstanceBean;
