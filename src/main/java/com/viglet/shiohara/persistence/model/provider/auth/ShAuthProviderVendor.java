...
public class ShAuthProviderVendor {
	...
	private List<ShAuthProviderInstance> instances;
	...
	public List<ShAuthProviderInstance> getInstances() {
		return instances;
	}

	public void setInstances(List<ShAuthProviderInstance> instances) {
