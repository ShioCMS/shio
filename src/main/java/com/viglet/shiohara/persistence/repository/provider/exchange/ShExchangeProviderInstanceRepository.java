...
package com.viglet.shiohara.persistence.repository.provider.exchange;
...
public interface ShExchangeProviderInstanceRepository extends JpaRepository<ShExchangeProviderInstance, String> {
