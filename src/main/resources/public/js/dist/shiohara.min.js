...
shioharaApp.service("shAPIServerService",["$http","$location","$cookies",function(a,b,d){var f=b.protocol(),e=b.host();b=b.port();var c=f+"://"+e+":"+b,g=c+"/api";console.log(c);this.server=function(){if(null!=d.get("shServer"))return d.get("shServer");a({method:"GET",url:g}).then(function(a){d.put("shServer",c)},function(a){d.put("shServer","http://localhost:2710")});return c};this.get=function(){if(null!=d.get("shAPIServer"))return d.get("shAPIServer");a({method:"GET",url:g}).then(function(a){d.put("shAPIServer",
g)},function(a){d.put("shAPIServer","http://localhost:2710/api")});return g}}]);
shioharaApp.factory("shChannelFactory",["$uibModal","shChannelResource","Notification","$filter",function(a,b,d,f){return{deleteFromList:function(a,c){this.modalDelete(a).result.then(function(g){deletedMessage="The "+a.name+" Channel was deleted.";b["delete"]({id:a.id},function(){var b=f("filter")(c,{id:a.id},!0)[0],b=c.indexOf(b);c.splice(b,1);d.error(deletedMessage)})},function(){})},modalDelete:function(b){return a.open({animation:!0,ariaLabelledBy:"modal-title",ariaDescribedBy:"modal-body",templateUrl:"template/modal/shDeleteObject.html",
...
shioharaApp.controller("ShChannelChildrenCtrl",["$scope","$state","$stateParams","$rootScope","$translate","$http","shAPIServerService","vigLocale","shChannelFactory","shPostFactory",function(a,b,d,f,e,c,g,h,k,m){a.siteId=d.siteId;a.channelId=d.channelId;a.$parent.channelId=d.channelId;a.vigLanguage=h.getLocale().substring(0,2);e.use(a.vigLanguage);a.shSite=null;a.shChannels=null;a.shPosts=null;a.breadcrumb=null;f.$state=b;a.$evalAsync(c.get(g.get().concat("/channel/"+a.channelId+"/list")).then(function(b){a.shChannels=
b.data.shChannels;a.shPosts=b.data.shPosts;a.breadcrumb=b.data.breadcrumb;a.$parent.breadcrumb=b.data.breadcrumb;a.shSite=b.data.shSite;a.$parent.shSite=a.shSite}));a.channelDelete=function(b){k.deleteFromList(b,a.shChannels)};a.postDelete=function(b){m.deleteFromList(b,a.shPosts)}}]);
shioharaApp.controller("ShChannelEditCtrl",["$scope","$http","$window","$state","$stateParams","$rootScope","Token","shChannelResource","shSiteResource","shAPIServerService","vigLocale","$location","$translate","Notification",function(a,b,d,f,e,c,g,h,k,m,l,n,p,q){a.channelId=e.channelId;a.vigLanguage=l.getLocale().substring(0,2);p.use(a.vigLanguage);a.shSite=null;a.shParentChannel=null;a.shChannel=null;a.breadcrumb=null;c.$state=f;a.shChannel=h.get({id:a.channelId});rootChannel=!1;1==a.shChannel.rootChannel&&
...
shioharaApp.controller("ShChannelNewCtrl",["$scope","$http","$window","$state","$stateParams","$rootScope","Token","shChannelResource","shSiteResource","shAPIServerService","vigLocale","$location","$translate","Notification",function(a,b,d,f,e,c,g,h,k,m,l,n,p,q){a.siteId=e.siteId;a.channelId=e.channelId;rootChannel=!1;null!=a.siteId&&(rootChannel=!0);a.vigLanguage=l.getLocale().substring(0,2);p.use(a.vigLanguage);a.shSite=null;a.shParentChannel=null;a.shChannel=null;a.breadcrumb=null;c.$state=f;a.$evalAsync(b.get(m.get().concat("/channel/model")).then(function(b){a.shChannel=
...
shioharaApp.controller("ShContentChildrenCtrl",["$scope","$http","$state","$stateParams","$rootScope","Token","shUserResource","shPostTypeResource","shAPIServerService","vigLocale","$translate","shChannelFactory","shPostFactory",function(a,b,d,f,e,c,g,h,k,m,l,n,p){a.vigLanguage=m.getLocale().substring(0,2);l.use(a.vigLanguage);a.siteId=f.siteId;a.channelId=null;a.accessToken=c.get();a.shUser=null;a.shSite=null;a.shPosts=null;a.shLastPostType=null;a.shChannels=null;e.$state=d;a.breadcrumb=null;null!=
a.siteId&&a.$evalAsync(b.get(k.get().concat("/site/"+a.siteId+"/channel")).then(function(b){a.shChannels=b.data.shChannels;a.shPosts=b.data.shPosts;a.shSite=b.data.shSite}));a.shUser=g.get({id:1,access_token:a.accessToken},function(){a.shLastPostType=h.get({id:a.shUser.lastPostType})});a.channelDelete=function(b){n.deleteFromList(b,a.shChannels)};a.postDelete=function(b){p.deleteFromList(b,a.shPosts)}}]);
...
c.cancel=function(){c.removeInstance=!1;a.dismiss("cancel")};c.selectFile=function(){e.modalSelectFile(c.shObject.shChannel.id).result.then(function(a){console.log("shPostSelected: "+a.id)},function(){})}}]);
...
shioharaApp.factory("shPostFactory",["$uibModal","shPostResource","Notification","$filter","$state",function(a,b,d,f,e){return{deleteFromList:function(a,e){this.modalDelete(a).result.then(function(h){var k="The "+a.title+" Post was deleted.";b["delete"]({id:a.id},function(){var b=f("filter")(e,{id:a.id},!0)[0],b=e.indexOf(b);e.splice(b,1);d.error(k)})},function(){})},"delete":function(a){this.modalDelete(a).result.then(function(f){deletedMessage="The "+a.title+" Post was deleted.";b["delete"]({id:a.id},
...
shioharaApp.controller("ShPostEditCtrl",["$scope","$http","$window","$stateParams","$state","$rootScope","shPostResource","shAPIServerService","Notification","Upload","$q","$timeout","shStaticFileFactory","shPostFactory",function(a,b,d,f,e,c,g,h,k,m,l,n,p,q){a.tinymceOptions={plugins:"link image code",toolbar:"undo redo | bold italic | alignleft aligncenter alignright | code"};var r=null,t=null;a.channelId=null;a.postId=f.postId;a.breadcrumb=null;a.shSite=null;a.shPost=g.get({id:a.postId},function(){null!=
...
shioharaApp.controller("ShPostNewCtrl",["$scope","$http","$window","$stateParams","$state","$rootScope","shAPIServerService","shPostResource","Notification","Upload","$q","$timeout","shStaticFileFactory",function(a,b,d,f,e,c,g,h,k,m,l,n,p){a.tinymceOptions={plugins:"link image code",toolbar:"undo redo | bold italic | alignleft aligncenter alignright | code"};a.channelId=f.channelId;a.postTypeId=f.postTypeId;a.breadcrumb=null;a.shPost=null;a.shChannel=null;var q=a.shSite=null;a.$evalAsync(b.get(g.get().concat("/channel/"+
...
shioharaApp.factory("shPostTypeResource",["$resource","shAPIServerService",function(a,b){return a(b.get().concat("/post/type/:id"),{id:"@id"},{update:{method:"PUT"}})}]);shioharaApp.controller("ShPostTypeAttrCtrl",["$scope","$http","$window","$stateParams","$state","$rootScope","shPostTypeAttrResource",function(a,b,d,f,e,c,g){a.postTypeAttrId=f.postTypeAttrId;a.shPostTypeAttr=g.get({id:a.postTypeAttrId});c.$state=e;a.postTypeAttrSave=function(){a.shshPostTypeAttrPost.$update(function(){e.go("content.post-type-item")})}}]);
shioharaApp.controller("ShPostTypeEditorCtrl",["$scope","$http","$window","$state","$rootScope","shAPIServerService","shPostTypeResource","Notification",function(a,b,d,f,e,c,g,h){e.$state=f;a.shPostType=null;a.$evalAsync(b.get(c.get().concat("/post/type/model")).then(function(b){a.shPostType=b.data}));a.postTypeSave=function(){delete a.shPostType.id;g.save(a.shPostType,function(){h.warning("The "+a.shPostType.name+" Site was created.");f.go("content.post-type-select")})}}]);
shioharaApp.controller("ShPostTypeItemCtrl",["$scope","$http","$window","$stateParams","$state","$rootScope","shWidgetResource","shPostTypeResource","shPostTypeAttrResource","shAPIServerService","Notification",function(a,b,d,f,e,c,g,h,k,m,l){a.postTypeId=f.postTypeId;a.shPostType=null;a.shWidgets=g.query();c.$state=e;a.shPostType=h.get({id:a.postTypeId},function(b){a.shPostNewItem=angular.copy(a.shPostType);for(b=0;b<a.shPostNewItem.shPostTypeAttrs.length;b++)a.shPostNewItem.shPostTypeAttrs[b].value=
...
shioharaApp.controller("ShPostTypeSelectCtrl",["$scope","$http","$window","$state","$stateParams","$rootScope","shPostTypeResource","shSiteResource","shAPIServerService",function(a,b,d,f,e,c,g,h,k){c.$state=f;a.shPostTypes=g.query();a.shSite=null;a.breadcrumb=null}]);
shioharaApp.controller("ShPostTypeSelectWithChannelCtrl",["$scope","$http","$window","$state","$stateParams","$rootScope","shPostTypeResource","shSiteResource","shAPIServerService",function(a,b,d,f,e,c,g,h,k){a.siteId=e.siteId;a.channelId=e.channelId;c.$state=f;a.shPostTypes=g.query();a.shSite=null;a.breadcrumb=null;null!=a.channelId?a.$evalAsync(b.get(k.get().concat("/channel/"+a.channelId+"/path")).then(function(b){a.breadcrumb=b.data.breadcrumb;a.shSite=b.data.currentChannel.shSite})):a.shSite=
h.get({id:a.siteId})}]);
...
shioharaApp.controller("ShSiteChildrenCtrl",["$scope","$http","$state","$stateParams","$rootScope","Token","shUserResource","shPostTypeResource","shAPIServerService","vigLocale","$translate","shChannelFactory","shPostFactory",function(a,b,d,f,e,c,g,h,k,m,l,n,p){a.vigLanguage=m.getLocale().substring(0,2);l.use(a.vigLanguage);a.siteId=f.siteId;a.channelId=null;a.accessToken=c.get();a.shUser=null;a.shSite=null;a.shPosts=null;a.shLastPostType=null;a.shChannels=null;e.$state=d;a.breadcrumb=null;a.$evalAsync(b.get(k.get().concat("/site/"+
a.siteId+"/channel")).then(function(b){a.shChannels=b.data.shChannels;a.shPosts=b.data.shPosts;a.shSite=b.data.shSite}));a.shUser=g.get({id:1,access_token:a.accessToken},function(){a.shLastPostType=h.get({id:a.shUser.lastPostType})});a.channelDelete=function(b){n.deleteFromList(b,a.shChannels)};a.postDelete=function(b){p.deleteFromList(b,a.shPosts)}}]);
...
shioharaApp.factory("shStaticFileFactory",["$q","Upload","shAPIServerService","$timeout",function(a,b,d,f){return{uploadFile:function(e,c,f,h,k,m){var l=a.defer();if("File"==c.shPostTypeAttr.shWidget.name&&null!=c.file){var n=!0;"PT-FILE"==h.name&&(n=!1);m++;file=c.file;file.$error||b.upload({url:d.get().concat("/staticfile/upload"),data:{file:file,channelId:e,createPost:n}}).then(function(a){filePath=a.data.title;n?(k.shPostAttrs[f].strValue=a.data.id,delete k.shPostAttrs[f].referenceObjects):k.shPostAttrs[f].strValue=
...
shioharaApp.controller("ShWidgetFileSelectCtrl",["$scope","shAPIServerService","$http","$uibModalInstance","channelId","shWidgetFileFactory",function(a,b,d,f,e,c){var g=this;g.shPostSelected=null;g.ok=function(){f.close(g.shPostSelected)};g.cancel=function(){g.shPostSelected=null;f.dismiss("cancel")};a.shSite=null;a.shChannels=null;a.shPosts=null;a.breadcrumb=null;a.channelList=function(c){g.shPostSelected=null;a.$evalAsync(d.get(b.get().concat("/channel/"+c+"/list/PT-FILE")).then(function(b){a.shChannels=
b.data.shChannels;a.shPosts=b.data.shPosts;a.breadcrumb=b.data.breadcrumb;a.shSite=b.data.shSite}))};a.siteList=function(c){g.shPostSelected=null;a.$evalAsync(d.get(b.get().concat("/site/"+c+"/channel")).then(function(b){a.shChannels=b.data.shChannels;a.shPosts=b.data.shPosts;a.shSite=b.data.shSite}))};a.selectedPost=function(a){g.shPostSelected=a};a.channelList(e)}]);